Contributing to cqoin Core
============================

The cqoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the cqoin Core build
...
The developer
[mailing list](contactcqoin@gmail.com)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to cqoin-qt
...
The following applies to code changes to the cqoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall cqoin
Network Protocol consensus changes.

Whether a pull request is merged into cqoin Core rests with the project merge
...
Patches that change cqoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the cqoin consensus, it must have been
...
The project leader is the release manager for each cqoin Core release.
